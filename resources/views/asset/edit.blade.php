...
<div class="app-content main-content">
    <div class="side-app main-container">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="serial_number" value="{{$assets->serial_number}}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="value" value="{{$assets->value}}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <textarea type="text" class="form-control" name="description" value=""
                                                placeholder="{{ __('Description') }}">{{$assets->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        $("#assets_post").submit(function() {
            ...
            axios.post("{{ route('assets-edit', $assets->id) }}", new FormData($("#assets_post")[0])).then(
                response => {
