@extends('layouts.app')
@section('title', 'Add Document Management')
@section('content')
    ...
    <div class="side-app main-container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                    <form method="post" id="document" action="" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <button id="submit" class="btn btn-primary btn-lg" type="submit" name="submit"> Submit</button>
...
$("#document").submit(function() {
    ...
    axios.post("{{ route('document-management-add') }}", new FormData($("#document")[0])).then(response => {
