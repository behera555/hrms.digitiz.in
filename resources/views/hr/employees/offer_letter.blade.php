@extends('layouts.app')
@section('title', 'Employee Appointment Letter')
@section('content')
    ...
    <div class="side-app main-container">
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <div class="page-title">Employees Appointment Letter</div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="offer_letter" action="" enctype="multipart/form-data">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label mb-0 mt-2">{{ __('Appointment Date') }}</label>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            </div><input name="offer_letter_date" class="form-control" data-bs-toggle="modaldatepicker" placeholder="MM/DD/YYYY" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input name="Probation_period" class="form-control" type="text" placeholder="Prohibition Period"></input>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            </div><textarea name="address" class="form-control" rows="4" cols="50" type="text"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
       ...
       <div class="row">
							<div class="col-xl-12 col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header  border-0">
										<h4 class="card-title">Appointment Letter Summary</h4>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="emp-attendance">
												...
												<tbody>
												    @foreach($employees_offer_letter as $key => $val)
													<tr>
														<td>{{ ($employees_offer_letter->currentpage()-1) * $employees_offer_letter->perpage() + $key + 1 }}</td>
											 ...
											 <nav aria-label="Page navigation">{!! $employees_offer_letter->links('pagination.custom') !!}</nav>
										</div>
									</div>
								</div>
							</div>
        ...
        $("#offer_letter").submit(function() {
            event.preventDefault();
            $("#submit").prop('disabled', true);
            $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>Loading....');
            axios.post("{{ route('employees-offer-letter') }}", new FormData($("#offer_letter")[0])).then(response => {
                var data = response.data;
                if (data.success) notif({msg: "<b><i class='fa fa-check-circle-o fs-20 me-2'></i></b> Offer Letter Submitted Successfully",
                    type: "success"}, setTimeout(function() { location.replace("{{ route('employees-offer-letter') }}"); }, 3000));
                else {
