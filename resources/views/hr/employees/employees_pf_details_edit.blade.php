        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
                    <form method="post" id="employees-pf-edit" action="" enctype="multipart/form-data">
                           ...
                           <div class="card-body">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <option value="{{$val->emp_id}}" {{ $val->emp_id == $employee_pf_details->emp_id ? 'selected' : '' }}>{{$val->name}}</option>
                                          @endforeach
                                        </select>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="pf_employee" value="{{$employee_pf_details->pf_employee}}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <input type="text" name="pf_employer" value="{{$employee_pf_details->pf_employer}}" class="form-control"
...
<script>
$("#employees-pf-edit").submit(function() {
    event.preventDefault();
     $("#submit").prop('disabled', true);
    $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>Loading....');
    axios.post("{{ route('employees-pf-details-edit', $employee_pf_details->id) }}", new FormData($("#employees-pf-edit")[0])).then(response => {
