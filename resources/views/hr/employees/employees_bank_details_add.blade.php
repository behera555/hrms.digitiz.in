    ...
    <div class="side-app main-container">
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <div class="page-title">Add Bank Details</div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
                    <form method="post" id="employees-bank" action="" enctype="multipart/form-data">
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="bank_name" class="form-control" placeholder="{{ __('Bank') }}">
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="pan" class="form-control" placeholder="{{ __('PAN') }}">
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" name="uan" class="form-control" placeholder="{{ __('UAN') }}">
                                            </div>
...
<script>
$("#employees-bank").submit(function() {
    event.preventDefault();
    $("#submit").prop('disabled', true);
    $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>Loading....');
    axios.post("{{ route('employees-bank-details-add') }}", new FormData($("#employees-bank")[0])).then(
        response => {
