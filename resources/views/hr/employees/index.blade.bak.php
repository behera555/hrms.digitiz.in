                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="mt-0 text-start"> <span class="font-weight-semibold">Total Male
                                        Employees</span>
                                    <h3 class="mb-0 mt-1 text-primary">{{DB::table('users')->join('employees_primary_details', function($join){
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="mt-0 text-start"> <span class="font-weight-semibold">Total Female
                                        Employees</span>
                                    <h3 class="mb-0 mt-1 text-secondary">{{DB::table('users')->join('employees_primary_details', function($join){
$join->on('users.emp_id', '=', 'employees_primary_details.emp_id')
                ...
                <div class="card">
                    <div class="card-header  border-0">
                        <h4 class="card-title">Employees List</h4>
                         &nbsp;&nbsp;&nbsp;<a href="{{route('download-employees-list')}}" class="btn btn-primary me-3"><i class="fa fa-download sidemenu_icon"></i> Employee List</a>
                    </div>
                    <div class="card-body">
                                ...
                                @foreach($employees as $key => $row)
                                    ...
                                    <td>{{ ($employees->currentpage()-1) * $employees->perpage() + $key + 1 }}</td>
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <div class="me-3 mt-0 mt-sm-1 d-block">
                                                    <h6 class="mb-1 fs-14">{{$row->display_name}}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>{{$row->emp_id}}</td>
                                        ...
                                        <td>
                                           ...
                                           <a href="#" onclick="validate('{{ $row->emp_id }}','{{ $row->display_name }}')" class="btn btn-danger btn-icon btn-sm"><i class="fa fa-toggle-off"></i></a>
                                           @else
