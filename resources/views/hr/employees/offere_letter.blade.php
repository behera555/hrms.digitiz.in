@extends('layouts.app')
@section('title', 'Employee Offer Letter')
@section('content')
    ...
    <div class="side-app main-container">
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <div class="page-title">Employees Offer Letter</div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="offere_letter" action="" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                         <div class="input-group">
                                            ...
                                            </div><input name="job_title" class="form-control" type="text"></input>
                                        </div>
                                    </div>
                                </div>
                            </div>
                              <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="form-label mb-0 mt-2">{{ __('Salary Amount') }}</label>
                                    </div>
                                    <div class="col-md-3">
                                         <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            </div><input name="salary_amount" class="form-control" type="text"></input>
                                        </div>
                                    </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                          <div class="input-group">
                                            ...
                                            </div><input name="joining_date" class="form-control" data-bs-toggle="modaldatepicker" placeholder="MM/DD/YYYY" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="form-label mb-0 mt-2">{{ __('Hr') }}</label>
                                    </div>
                                    <div class="col-md-3">
                                         <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            </div><input name="hr_name" class="form-control" type="text"></input>
                                        </div>
                                    </div>
                                        <div class="col-md-3">
                                        <label class="form-label mb-0 mt-2">{{ __('Hr Phone NO') }}</label>
                                    </div>
                                    <div class="col-md-3">
                                          <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            </div><input name="hr_phone_no" class="form-control" type="text">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label class="form-label mb-0 mt-2">{{ __('Reporting To') }}</label>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="input-group">
                                        <select class="form-control select2-show-search custom-select" name="reporting_to">
       ...
       <div class="row">
							<div class="col-xl-12 col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header  border-0">
										<h4 class="card-title">Offer Letter Summary</h4>
									</div>
									<div class="card-body">
										<div class="table-responsive">
											<table class="table  table-vcenter text-nowrap table-bordered border-bottom" id="emp-attendance">
												...
												<tr>
														...
														<th class="border-bottom-0">Employee Salary</th>
														<th class="border-bottom-0">Employee Designation</th>
														<th class="border-bottom-0">Employee Reporting To</th>
														<th class="border-bottom-0">Employee Offer Date</th>
														<th class="border-bottom-0">Action</th>
													</tr>
												</thead>
												<tbody>
												    @foreach($employees_offere_letter as $key => $val)
													<tr>
                                                        <td>{{$val->id}}</td>
											 ...
											 <nav aria-label="Page navigation">{!! $employees_offere_letter->links('pagination.custom') !!}</nav>
										</div>
									</div>
								</div>
							</div>
        ...
        $("#offere_letter").submit(function() {
            event.preventDefault();
            $("#submit").prop('disabled', true);
            $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>Loading....');
            axios.post("{{ route('employees-offere-letter') }}", new FormData($("#offere_letter")[0])).then(response => {
                var data = response.data;
                if (data.success) notif({msg: "<b><i class='fa fa-check-circle-o fs-20 me-2'></i></b> Offere Letter Submitted Successfully",
                    type: "success"}, setTimeout(function() { location.replace("{{ route('employees-offere-letter') }}"); }, 3000));
                else {
...
function validate(id, title) {
    swal({
        ...
        $.ajax({
            type: 'DELETE',
            url: "{{ route('employees-offere-letter-destroy') }}" + '/' + id,
