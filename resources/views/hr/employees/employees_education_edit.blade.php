        ...
        <div class="row">
            <div class="col-xl-12 col-md-12 col-lg-12">
                <div class="panel-body tabs-menu-body hremp-tabs1 p-0">
                    <form method="post" id="employees-education-edit" action="" enctype="multipart/form-data">
                        <div class="card-body">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <option value="{{$val->emp_id}}" {{ $val->emp_id == $employees_education_details->emp_id ? 'selected' : '' }}>{{$val->name}}</option>
                                          @endforeach
                                        </select>
                                        </div>
                                    </div>
                                     @else
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="hidden" value="{{$employees_education_details->emp_id}}" name="emp_id" class="form-control"
                                        ...
                                        @endif
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{$employees_education_details->degree}}" name="degree" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{$employees_education_details->specialization}}" name="specialization" class="form-control"
                                                    placeholder="{{ __('Branch / Specialization') }}">
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{$employees_education_details->year_of_joining}}" name="year_of_joining" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{$employees_education_details->year_of_completion}}" name="year_of_completion" class="form-control"
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{$employees_education_details->cgpa}}" name="cgpa" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <input type="text" value="{{$employees_education_details->college}}" name="college" class="form-control"
...
<script>
$("#employees-education-edit").submit(function() {
    event.preventDefault();
     $("#submit").prop('disabled', true);
     $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>Loading....');
      @if(auth()->user()->type == 'hr')
    axios.post("{{ route('employees-education-edit', $employees_education_details->id) }}", new FormData($("#employees-education-edit")[0])).then(
        @else
        axios.post("{{ route('education-edit', $employees_education_details->id) }}", new FormData($("#employees-education-edit")[0])).then(
        @endif
        response => {
            ...
            @else
            if (data.success) 
            notif({ msg: "<b><i class='fa fa-check-circle-o fs-20 me-2'></i></b>Employees Education Submitted Successfully", type: "success" }, setTimeout(function() { location.replace("{{ route('education') }}"); }, 3000));
            else {
                 $("#submit").prop('disabled', false);
                 $("#submit").html('Submit');
                for (var a in data['error']['message']) {
