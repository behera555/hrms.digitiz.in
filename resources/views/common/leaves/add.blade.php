@extends('layouts.app')
@section('title', 'Add Leave Type List')
@section('content')
    ...
    <div class="side-app main-container">
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <div class="page-title">Add Leave Settings</div>
            </div>
        </div>
        <!-- END PAGE HEADER -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="leave" action="" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="type_of_leaves" value=""
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            </div><input name="number_of_days" value="" class="form-control"
...
$("#leave").submit(function() {
    ...
    axios.post("{{ route('add-leaves') }}", new FormData($("#leave")[0])).then(response => {
        var data = response.data;
        $('#leave')[0].reset();
        if (data.success)  notif({ msg: "<b><i class='fa fa-check-circle-o fs-20 me-2'></i></b> Add Leave Submitted Successfully", type: "success" },setTimeout(function() { location.replace("{{ route('leaves') }}"); }, 3000));
        else { 
