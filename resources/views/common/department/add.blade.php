    ...
    <div class="side-app main-container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                    <form method="post" id="department" action="" enctype="multipart/form-data">
                        
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-3">
                                    <label class="form-label mb-0 mt-2">{{ __('Add Department') }}</label>
                                </div>
                                <div class="col-md-6">
...
<script>
    $("#department").submit(function() {
        ...
        axios.post("{{ route('department-post') }}", new FormData($("#department")[0])).then(response => {
            var data = response.data;
            $('#department')[0].reset();
            if (data.success) notif({ msg: "<b><i class='fa fa-check-circle-o fs-20 me-2'></i></b>Department Submitted Successfully", type: "success" },setTimeout(function() { location.replace("{{ route('hr-department') }}"); }, 3000));
            else {
