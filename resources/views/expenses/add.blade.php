                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        </div><input name="price" value="" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        </div><input name="purchase_date" value="" class="form-control"
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        </div><input name="bill" value="" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <button id="submit" class="btn btn-primary btn-lg" type="submit" name="submit"> Save</button>
                                  @if(auth()->user()->type == 'hr')
                                    <a href="{{ route('hr-expenses-list') }}" class="btn btn-danger btn-lg">Cancel</a>
                                    @else
...
$("#expenses").submit(function() {
    ...
    $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading....');
     @if(auth()->user()->type == 'hr')
     axios.post("{{ route('hr-expenses-add') }}", new FormData($("#expenses")[0])).then(response => {
        @else
        axios.post("{{ route('expenses-add') }}", new FormData($("#expenses")[0])).then(response => {
        @endif
