                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="mt-0 text-start"> <span
                                            ...
                                            <h3 class="mb-0 mt-1 mb-2">{{ $data['no_of_department'] }}</h3>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <div class="btn-list">
                                        <a href="javascript:void(0);"
                                            class="btn  btn-outline-light text-dark float-start d-flex my-sm-0 my-1"><span
                                                class="dot-label bg-light4 me-2 my-auto"></span>Employees</a>
                                        <a href="javascript:void(0);"
                                            class="btn  btn-outline-light text-dark float-start d-flex my-sm-0 my-1"><span
                                                class="dot-label bg-primary1 me-2 my-auto"></span>Budget</a>
                                        <a href="javascript:void(0);" class="btn btn-outline-light my-sm-0 my-1"
                                            data-bs-toggle="dropdown" aria-expanded="false"> Year <i
                    ...
                    <div class="pt-2">
                        <div class="list-group">
                            <div class="list-group-item d-flex pt-3 pb-3 border-0">
                                ...
                                <div class="ms-1">
                                    <div class="h5 fs-14 mb-1">Board meeting Completed</div> <small
                                        class="text-muted">attend the company mangers...</small>
                                </div>
                            </div>
                            <div class="list-group-item d-flex pt-3 pb-3 border-0">
                                <div class="me-3 me-xs-0">
                                    <div class="calendar-icon icons">
                                        <div class="date_time bg-success-transparent "> <span class="date">16</span>
                ...
                <div class="mb-4">
                    ...
                    <ul class="vertical-scroll">
                        <li class="item">
                            <div class="card p-4 ">
                                <div class="d-flex">
                                    <img src="{{asset('backend/images/users/16.jpg')}}" alt="img"
                                        class="avatar avatar-md bradius me-3">
                                    <div class="me-3 mt-0 mt-sm-1 d-block">
                                        <h6 class="mb-1">Himaja dindukurthi</h6>
                        ...
                        <li class="item">
                            <div class="card p-4 ">
                                <div class="d-flex">
                                    <img src="{{asset('backend/images/users/4.jpg')}}" alt="img"
                                        class="avatar avatar-md bradius me-3">
                                    <div class="me-3 mt-0 mt-sm-1 d-block">
            ...
            <div class="col-xl-4 col-md-12 col-lg-6">
                <div class="card">
                    <div class="card-header border-0">
                        ...
                        <div class="card-options">
                            <div class="dropdown"> <a href="javascript:void(0);" class="btn btn-outline-light"
                                    data-bs-toggle="dropdown" aria-expanded="false"> Week <i
                                        class="feather feather-chevron-down"></i> </a>
                                <ul class="dropdown-menu dropdown-menu-end" role="menu">
                                    <li><a href="javascript:void(0);">Monthly</a></li>
                                    <li><a href="javascript:void(0);">Yearly</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="sales-chart mt-4 row text-center">
                            <div class="d-flex my-auto col-sm-4 mx-auto text-center justify-content-center"><span
                                    class="dot-label bg-primary1 me-2 my-auto"></span>On progress</div>
                            <div class="d-flex my-auto col-sm-4 mx-auto text-center justify-content-center"><span
                                    class="dot-label bg-secondary1 me-2 my-auto"></span>Pending</div>
                            <div class="d-flex my-auto col-sm-4 mx-auto text-center justify-content-center"><span
                                    class="dot-label bg-light4  me-2 my-auto"></span>Completed</div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="timeline">
                            <li>
                                <a target="_blank" href="javascript:void(0);"
                                    class="font-weight-semibold fs-15 ms-3">Leave Approval Request</a>
                            ...
                            <li class="primary">
                                <a target="_blank" href="javascript:void(0);"
                                    class="font-weight-semibold fs-15 mb-2 ms-3">Wok Update</a>
                            ...
                            <li class="pink">
                                <a target="_blank" href="javascript:void(0);"
                                    class="font-weight-semibold fs-15 mb-2 ms-3">Received Mail</a>
                                <a href="javascript:void(0);" class="text-muted float-end fs-13">15 min ago</a>
                                <p class="mb-0 pb-0 text-muted fs-11 pt-1 ms-3">Emergency Sick Leave from "jacob Berry"
                                </p>
                                <span class="text-muted ms-3 fs-11">Ui Designer, Designer Team.</span>
                            </li>
                            <li class="success mb-0 pb-0">
                                <a target="_blank" href="javascript:void(0);"
                                    class="font-weight-semibold fs-15 mb-2 ms-3">Job Application Mail</a>
                                <a href="javascript:void(0);" class="text-muted float-end fs-13">1 Hour ago</a>
                                <p class="mb-0 pb-0 text-muted fs-11 pt-1 ms-3">From jobmail@gmail.com laravel
                                    developer.</p>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="card chart-donut1">
                    ...
                    <div class="card-body">
                        ...
                        <div class="sales-chart pt-5 pb-3 d-flex mx-auto text-center justify-content-center ">
                            <div class="d-flex me-5"><span class="dot-label bg-primary1 me-2 my-auto"></span>Male</div>
                            <div class="d-flex"><span class="dot-label bg-secondary1  me-2 my-auto"></span>Female</div>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <table class="table mb-0 text-nowrap">
                                        <tbody>
                                            ...
                                            <tr class="border-bottom">
                                                <td>
                                                    <div class="d-flex">
                                                        <img src="{{asset('backend/images/users/1.jpg')}}" alt="img"
                                                            class="avatar avatar-md brround me-3">
                                                        <div class="me-3 mt-0 mt-sm-1 d-block">
                                                            <h6 class="mb-0">natasha</h6>
                                                            <div class="clearfix"></div>
                                                            <small class="text-muted">corporate relations</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-start fs-13">2 years</td>
                                                <td class="text-start fs-13"><i
                                                        class="feather feather-map-pin text-muted me-2"></i>India</td>
                                                <td class="text-end">
                                                    <a href="javascript:void(0);" class="action-btns"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Contact"><i
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <img src="{{asset('backend/images/users/4.jpg')}}" alt="img"
                                                            class="avatar avatar-md brround me-3">
                                                        <div class="me-3 mt-0 mt-sm-1 d-block">
                                                            <h6 class="mb-0">Cinna</h6>
                                                            <div class="clearfix"></div>
                                                            <small>Education relations</small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-start fs-13">1 years</td>
                                                <td class="text-start fs-13"><i
                                                        class="feather feather-map-pin text-muted me-2"></i>Germany</td>
                                                <td class="text-end">
                                                    <a href="javascript:void(0);" class="action-btns"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Contact"><i
                                            ...
                                            <tr class="border-bottom">
                                                <td>
                                                    <div class="d-flex">
                                                        <img src="{{asset('backend/images/users/8.jpg')}}" alt="img"
                                                            class="avatar avatar-md brround me-3">
                                                        <div class="me-3 mt-0 mt-sm-1 d-block">
                                        ...
                                        <tbody>
                                            <tr class="border-bottom">
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="me-3 mt-3 d-block">
                                                            <h6 class="mb-0 fs-13 font-weight-semibold">UI UX Designers
                                                            </h6>
                                                            <div class="clearfix"></div>
                                                ...
                                                <td class="text-start fs-13"><i
                                                        class="feather feather-map-pin text-muted me-2"></i>USA</td>
                                                <td class="text-end">
                                                    <a href="javascript:void(0);" class="action-btns"><i
                                            ...
                                            <tr class="border-bottom">
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="table_img brround bg-light me-3">
                                                            <img src="{{asset('backend/images/photos/html.png')}}"
                                            ...
                                            <tr class="border-bottom">
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="table_img brround bg-light me-3">
                                                            <img src="{{asset('backend/images/photos/jquery.png')}}"
                                                                alt="img" class=" bg-light brround">
                                                        </div>
                                                        <div class="me-3 mt-3 d-block">
                                                            <h6 class="mb-0 fs-13 font-weight-semibold">Experienced
                                                                Jquery Developer</h6>
                                                            <div class="clearfix"></div>
                                            ...
                                            <tr class="border-bottom">
                                                <td>
                                                    <div class="d-flex">
                                                        <div class="table_img brround bg-light me-3">
                                                            <img src="{{asset('backend/images/photos/vue.png')}}"
                                                                alt="img" class=" bg-light brround">
                                                        </div>
                                                        <div class="me-3 mt-3 d-block">
                                                            <h6 class="mb-0 fs-13 font-weight-semibold">Vue js Developer
                                                            </h6>
                                                            <div class="clearfix"></div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="me-3 mt-3 d-block">
                                                            <h6 class="mb-0 fs-13 font-weight-semibold">Kimberly Berry
                                                            </h6>
                                                            <div class="clearfix"></div>
                                    ...
                                    <table class="table mb-0 text-nowrap">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex">
                                                        <img src="{{asset('backend/images/users/9.jpg')}}" alt="img"
                                                            class="avatar avatar-md brround me-3">
                                                        <div class="me-3 mt-0 mt-sm-1 d-block">
                                                            <h6 class="mb-0">Kimberly Berry</h6>
                                                            <div class="clearfix"></div>
                ...
                <div class="card">
                    <div class="card-header border-0">
                        ...
                        <div class="card-options ">
                            ...
                            <div class="dropdown"> <a href="javascript:void(0);"
                                    class="btn btn-outline-light dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false"> Date <i class="feather feather-chevron-down"></i> </a>
                                <ul class="dropdown-menu dropdown-menu-end" role="menu">
                                    <li><a href="javascript:void(0);">Monthly</a></li>
                                    <li><a href="javascript:void(0);">Yearly</a></li>
                                    <li><a href="javascript:void(0);">Weekly</a></li>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0);" class="action-btns" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Chat"><i
                                                class="feather-message-circle  text-success"></i></a>
                                    </td>
                                </tr>
                                <tr class="border-bottom">
