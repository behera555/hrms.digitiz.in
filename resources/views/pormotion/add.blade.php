    ...
    <div class="side-app main-container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="pormotion_post" action="" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="promotion_new_salary" class="form-control"
                                                        placeholder="{{ __('Promotion New Salary') }}">
                                                </div>
                                                <div class="col-md-3">
                                                    <label
        ...
        $("#pormotion_post").submit(function() {
            event.preventDefault();
            $("#submit").prop('disabled', true);
            $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading....');
            axios.post("{{ route('pormotion-add') }}", new FormData($("#pormotion_post")[0])).then(response => {
                var data = response.data;
                $('#pormotion_post')[0].reset();
