    ...
    <div class="side-app main-container">
        ...
        <div class="page-header d-xl-flex d-block">
            <div class="page-leftheader">
                <div class="page-title">{{ __('Add Award') }}</div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="post" id="award_post" action="" enctype="multipart/form-data">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="{{ __('Award Name') }}" name="{{ __('award_name') }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" placeholder="{{ __('Gift Item') }}" name="{{ __('gift_item') }}">
                                    </div>
                                     <div class="form-group">
        ...
        $("#award_post").submit(function() {
            event.preventDefault();
            $("#submit").prop('disabled', true);
            $("#submit").html('<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading....');
            axios.post("{{ route('award-add') }}", new FormData($("#award_post")[0])).then(response => {
                var data = response.data;
                $('#award_post')[0].reset();
                if (data.success) notif({
                    msg: "<b><i class='fa fa-check-circle-o fs-20 me-2'></i></b> Award Submitted Successfully",
                    type: "success"
                }, setTimeout(function() {
